...
<head>
    ...
    <title>RPC Semi Expendable Properties (Low Value) Report</title>
        ...
        <div class="details">
            ...
            <div class="rpc-semi-content">
                ...
                <div class="report-header">
                    <h1>REPORT ON THE PHYSICAL COUNT OF SEMI-EXPENDABLE PROPERTIES (LOW VALUE)</h1>
                ...
                <div class="filters-section">
                    <form method="GET" action="{{ route('client.report.rpc-semi-low') }}" class="filters-form">
                        ...
                        <div class="filter-actions">
                            ...
                            <a href="{{ route('client.report.rpc-semi-low') }}" class="btn btn-secondary">
