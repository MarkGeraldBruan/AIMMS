...
<head>
    ...
    <title>RPC Semi Expendable Properties (High Value) Report</title>
    ...
    <style>
        ...
        @media print {
            ...
            * {
            ...
            .equipment-table th:nth-child(1), .equipment-table td:nth-child(1) { width: 12%; }
            .equipment-table th:nth-child(2), .equipment-table td:nth-child(2) { width: 15%; }
            .equipment-table th:nth-child(3), .equipment-table td:nth-child(3) { width: 10%; }
            .equipment-table th:nth-child(4), .equipment-table td:nth-child(4) { width: 8%; }
            .equipment-table th:nth-child(5), .equipment-table td:nth-child(5) { width: 8%; }
            .equipment-table th:nth-child(6), .equipment-table td:nth-child(6) { width: 7%; }
            .equipment-table th:nth-child(7), .equipment-table td:nth-child(7) { width: 6%; }
            .equipment-table th:nth-child(8), .equipment-table td:nth-child(8) { width: 6%; }
            .equipment-table th:nth-child(9), .equipment-table td:nth-child(9) { width: 5%; }
            .equipment-table th:nth-child(10), .equipment-table td:nth-child(10) { width: 5%; }
            .equipment-table th:nth-child(11), .equipment-table td:nth-child(11) { width: 6%; }
            .equipment-table th:nth-child(12), .equipment-table td:nth-child(12) { width: 6%; }
            .equipment-table th:nth-child(13), .equipment-table td:nth-child(13) { width: 6%; }

            .text-center { text-align: center; }
            .text-right { text-align: right; }
            .page-break { page-break-before: always; }
            .classification-section { page-break-inside: avoid; }
            * { box-sizing: border-box !important; }
            .rpc-semi-content * { max-width: 100% !important; }
        }
    </style>
</head>
<body>
        ...
        <div class="details">
            ...
            <div class="rpc-semi-content">
                ...
                <div class="report-header">
                    <h1>REPORT ON THE PHYSICAL COUNT OF SEMI-EXPENDABLE PROPERTIES (HIGH VALUE)</h1>
                ...
                <div class="filters-section">
                    <form method="GET" action="{{ route('client.report.rpc-semi-high') }}" class="filters-form">
                        ...
                        <div class="filter-actions">
                            ...
                            <a href="{{ route('client.report.rpc-semi-high') }}" class="btn btn-secondary">
